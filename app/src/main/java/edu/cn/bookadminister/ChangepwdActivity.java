...
public class ChangepwdActivity extends AppCompatActivity {
    ...
    private Button bt_changeandlogin;
    ...
    public void init(){
        ...
        bt_changeandlogin = (Button)findViewById(R.id.bt_changeandlogin);
        bt_changeandlogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(userName)){
                    ...
                    Toast.makeText(ChangepwdActivity.this, "请再次输入密码", Toast.LENGTH_SHORT).show();
                    return;
                }else if(!passWord.equals(passWord_sure)){
                    Toast.makeText(ChangepwdActivity.this, "输入两次的密码不一样", Toast.LENGTH_SHORT).show();
                    return;
                    /**
                     *从SharedPreferences中读取输入的用户名，判断SharedPreferences中是否有此用户名
                     */
                }else if(isExistUserName(userName)){
                    Toast.makeText(ChangepwdActivity.this, "此账户名已经存在", Toast.LENGTH_SHORT).show();
                    return;
                }else{
                    ...
                    Intent intent = new Intent(ChangepwdActivity.this,UserActivity.class);
